...
const HeroSection = () => {
  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-between overflow-hidden pt-16 pb-8 bg-background">
      ...
      <div className="flex flex-1 items-center justify-center w-full" style={{ isolation: 'auto' }}>
        <img
          src="/logo-iaclowd-v3.png"
          alt="IAcloWd Logo"
          className="relative max-h-[70vh] max-w-full w-full object-contain mix-blend-screen"
        />
      </div>
